...
def apakin_alert():
    ...
    @task
    def alert_metrics():
        run_alerts(chat = 502411485)
    
    alert_metrics()
    
apakin_alert = apakin_alert()
